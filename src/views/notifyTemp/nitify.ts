...
export const NOTIFY_SUCCESS = (Noti: NOTIFYinterface) => {
  NotifyPlugin.success({
    title: Noti.title === null ? "Success" : Noti.title,
    content:
      Noti.content === null ? "Welcome TO TDesign-VNEXT WEBSITE" : Noti.content,
...
export const NOTIFY_ERROR = (Noti: NOTIFYinterface) => {
  NotifyPlugin.success({
    title: Noti.title === null ? "Success" : Noti.title,
    content:
      Noti.content === null ? "Welcome TO TDesign-VNEXT WEBSITE" : Noti.content,
